...
- **主站**：<https://rertchat.ruanftrix.cn>
...
A：每个对话都有一个唯一的6位数字ID，可以通过 `https://rertchat.ruanftrix.cn/?chat=123456` 直接访问。点击对话列表中的对话会自动更新URL。
...
**想要获取更多详细的帮助和完整的 FAQ，请访问**：<https://rertchat.ruanftrix.cn/faq>
...
详细的 API 文档请访问：<https://rertchat.ruanftrix.cn/docs/>
